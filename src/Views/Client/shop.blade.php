    ...
    <div class="col-span-9 ">
        ...
        <div class="pagination__wrapper mt-4">
                <ul class="pagination flex justify-center gap-4 ">
                    @if ($page > 1)
                        <li><a href="{{ url('shop?page=' . ($page - 1 == 0 ? 1 : $page - 1)) }}"  class="border border-solid border-[#CA8A04] m-1 py-2 px-4 bg-white text-black hover:bg-[#CA8A04] inline-block  font-bold rounded-md" class="prev"
                                title="previous page">&#10094;</a></li>
                    @endif
                    @for ($i = 1; $i <= $totalPage; $i++)
                        <li >
                            <a href="{{ url('shop?page=' . $i) }}" class="border border-solid border-[#CA8A04] m-1 py-2 px-4 bg-white text-black hover:bg-[#CA8A04] inline-block  font-bold rounded-md"
                                class="{{ $page == $i ? 'active' : '' }}">{{ $i }}</a>
                        </li>
                    @endfor
                    @if ($page < $totalPage)
                        <li ><a href="{{ url('shop?page=' . ($page + 1 > $totalPage ? $totalPage : $page + 1)) }}" class="border border-solid border-[#CA8A04] m-1 py-2 px-4 bg-white text-black hover:bg-[#CA8A04] inline-block  font-bold rounded-md"
